...
Route::get('paypal/tip/success/{user}', function ($user) {
    session()->put('subscription_success', trans('general.donation_sent_success'));
    return redirect($user);
});
Route::get('paypal/donate/success/{user}', function ($user) {
...
Route::get('paypal/donate/cancel/{user}', function ($user) {
    session()->put('subscription_cancel', trans('general.payment_cancelled'));
    return redirect($user);
});
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('donation')->group(function () {
        ...
        Route::get('{id}/delete', [DonationController::class, 'destroy'])->name('donation.destroy');
        Route::post('media/upload', [DonationController::class, 'mediaUpload']);
        Route::post('media/delete', [DonationController::class, 'mediaDelete']);
    });
    // Replies
    ...
    Route::post('send/donate', [DonationController::class, 'send']);
    //Send Donation
    Route::post('send/donation', [DonationController::class, 'send']);
    // Pay Per Views
